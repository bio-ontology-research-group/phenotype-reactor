...
class Command(BaseCommand):
    help = 'Training kg data using fasttext'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            outdir = join(KGE_DIR, 'fasttext' + '-' + testset_name + '-' + (exp_name + '-' if exp_name else '') + str(datetime.date.today())) 
            cwd = os.getcwd()
